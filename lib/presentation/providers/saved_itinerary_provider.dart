...
//   SavedItineraryNotifier(this._ref) : super([]) {
//     // Initial load attempt when the provider is first created
//     loadItineraries();

//     // Listen for changes in the authentication state.
//     // When a user logs in or out, this will trigger a reload.
//     _ref.listen(authProvider, (previous, next) {
//       loadItineraries();
//     });
//   }
...
//       state = box.values.toList().reversed.toList();
//     } else {
//       // If the box isn't open or user isn't logged in, ensure the state is empty
//       state = [];
//     }
//   }
