...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _initSpeech();
    // ---- THE REDUNDANT LOADING CODE HAS BEEN REMOVED FROM HERE ----
    // The provider now handles its own loading reactively.
  }
...
//     super.initState();
//     _initSpeech();
//     // This ensures the list is always fresh when the screen is shown.
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       ref.read(savedItineraryProvider.notifier).loadItineraries();
//     });
//   }
...
//                         backgroundColor: AppTheme.primaryColor,
//                         radius: 22,
//                         child: Text(userInitial, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
//                       ),
//                     )
//                   ],
//                 ),
...
//                       } else {
//                         ScaffoldMessenger.of(context).showSnackBar(
//                           const SnackBar(content: Text('Tell me what should I plan first!'))
//                         );
//                       }
//                     },
//                     style: ElevatedButton.styleFrom(
...
//                     ),
//                     child: const Text('Create My Itinerary', style: TextStyle(fontSize: 19),),
//                   ),
//                 ),
//                 const SizedBox(height: 60),
//                 Text(
...
//                 const SizedBox(height: 20),
//                 savedItineraries.isEmpty
//                     ? Center(child: Text('No saved itineraries yet.', style: Theme.of(context).textTheme.bodyMedium))
//                     : ListView.builder(
//                         shrinkWrap: true,
//                         itemCount: savedItineraries.length,
//                         itemBuilder: (context, index) {
...
//                             direction: DismissDirection.endToStart,
//                             onDismissed: (_) {
//                               ref.read(savedItineraryProvider.notifier).deleteItinerary(conversation.id);
//                               ScaffoldMessenger.of(context).showSnackBar(
//                                 SnackBar(content: Text('Itinerary deleted.')),
//                               );
//                             },
//                             background: Container(
//                               color: Colors.red,
...
//                                 onTap: () => context.push('/saved-itinerary-view', extra: conversation),
//                               ),
//                             ),
//                           );
//                         },
